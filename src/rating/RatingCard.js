        ...
        <div className="ratingCard">
            ...
            <div className="ratingCard_infor">
                ...
                <div className="ratingCard_infor_content">
                    Món này đúng thật rất ngon nhưng chỉ tội hơi thiếu muối Món
                    này đúng thật rất ngon nhưng chỉ tội hơi thiếu muối Món này
                    đúng thật rất ngon nhưng chỉ tội hơi thiếu muối Món này đúng
                    thật rất ngon nhưng chỉ tội hơi thiếu muối
                </div>
            </div>
        </div>
    );
