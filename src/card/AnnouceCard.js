		...
		<div className="annouce_card">
			...
			<div className="annouce_card_detail">
				<div className="annouce_card_detail_content">
					Chào mừng bạn đã gia nhập F11. Hãy luôn theo đuổi đam mê, kiên trì và
					theo đuổi mục tiêu tới cùng bạn nhé
				</div>
				<div className="annouce_card_detail_notification">12 giờ trước</div>
			</div>
		</div>
	);
};
